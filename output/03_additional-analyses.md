...
aggregate   comparison    estimate   std.error   statistic   p_value  ci              
----------  -----------  ---------  ----------  ----------  --------  ----------------
...
proximity    prop_mean   prop_sd  prop_ci           asin_mean   asin_sd  asin_ci        
----------  ----------  --------  ---------------  ----------  --------  ---------------
...
aggregate   group           *BIC*(H~0~)   *BIC*(H~1~)   *BF~01~*
----------  -------------  ------------  ------------  ---------
...
grouping    prop_mean   prop_sd  prop_ci           asin_mean   asin_sd  asin_ci        
---------  ----------  --------  ---------------  ----------  --------  ---------------
